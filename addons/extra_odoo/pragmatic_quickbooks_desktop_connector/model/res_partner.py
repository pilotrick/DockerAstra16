...
#         return vals
    ...
    def create_customers(self, partners, list_id=None):
        ...
        for partner in partners:
            ...
            if 'quickbooks_id' in partner and partner.get('quickbooks_id'):
                ...
                _logger.info("Partner ID==>>>>>>>>>{}".format(partner_id))
                if not partner_id:
                    ...
                    _logger.info("NEW PARTNER ID===>>>>>>>>>>{}\n\n\n\n\n\n\n".format(new_partner_id))
                else:
    ...
    def _prepare_partner_dict(self, partner, parent_id=False):
        _logger.info("\n\n\n\nPREPARE PARTNER DICT===>>>>>>>>{}".format(partner))
        vals = {}
        state = None
        country = None
        ...
        if company.export_updated_record == False:
            ...
            if partner_id:
                ...
                partners = self.search(
                    [('quickbooks_id', '=', False), ('customer_rank', '=', 1), ('is_company', '=', True)], limit=limit)
