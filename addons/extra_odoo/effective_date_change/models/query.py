class QueryList:
    ...
    update_stock_picking_by_id = "UPDATE stock_picking SET date_done = (%s) WHERE id = %s"
    ...
    update_stock_move_by_picking = "UPDATE stock_move SET date = (%s) WHERE picking_id = %s"
    update_stock_move_by_ref_tuple = "UPDATE stock_move SET date = (%s), date_deadline = date WHERE reference IN %s"
    update_stock_move_line = "UPDATE stock_move_line SET date = (%s) WHERE reference = %s"
    update_stock_move_line_by_picking = "UPDATE stock_move_line SET date = (%s) WHERE picking_id = %s"
    ...
    find_id_from_stock_picking = "SELECT name FROM stock_picking WHERE id = %s"
