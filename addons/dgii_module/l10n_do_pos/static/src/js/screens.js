    ...
    screens.PaymentScreenWidget.include({
        ...
        get_next_ncf: function (order) {
            var self = this,
                args = [
                    order.uid,
                    order.get_client().l10n_latam_document_type_id,
            ...
            if (this.order_is_valid(force_validation)) {
                ...
                if (orderValidationDate && now - orderValidationDate <= 5000) {
                    ...
                    if (!client && invoicing) {
                        ...
                        if (["fiscal", "gov", "special"].indexOf(client.l10n_latam_document_type_id) > -1) {
                            popupErrorOptions = {
        ...
        customer_changed: function () {
            ...
            var clientFiscalType = client && client.l10n_latam_document_type_id || '';
