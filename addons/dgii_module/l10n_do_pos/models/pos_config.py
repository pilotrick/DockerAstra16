...
class PosConfig(models.Model):
    ...
    number_of_days = fields.Integer(string=u'Cantidad de Días Anteriores',
                                    default=10)
    order_search_criteria = fields.Many2many('pos.search_criteria',
                                             string=u"Criterios de Búsqueda")
    ncf_control = fields.Boolean(related="invoice_journal_id.l10n_latam_use_documents")
