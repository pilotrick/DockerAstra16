...
registry.category('theme_prime_snippet_registry')
    ...
    .add('s_d_single_product_count_down', { widgets: { ...SELECTOR_DATA, }, defaultValue: { recordsLimit: 5 } })
    .add('s_two_column_cards', { widgets: { ...SELECTOR_DATA, TpUiComponent: { cardRegistry: 'theme_prime_two_column_card_registry', defaultVal: { style: 'tp_two_column_card_style_1', mode: 'slider', activeActions: PRODUCTS_ACTIONS_2} } } })
    .add('s_d_products_grid', { widgets: { ...SELECTOR_DATA }, defaultValue: { recordsLimit: 9} })
    .add('s_d_category_snippet', { widgets: { ...CATEGORY_SELECTOR_DATA, TpUiComponent: { cardRegistry: 'theme_prime_card_registry', defaultVal: { style: 's_card_style_1', sortBy: 'list_price asc', tabStyle: 'tp-droggol-dynamic-snippet-tab-1', mode: 'slider', limit: 8, ppr: 4, includesChild: true, activeActions: PRODUCTS_ACTIONS, mobileConfig: { style: 'default', mode: 'default' }} } } })
    ...
    .add('s_d_single_category_snippet', { widgets: { ...CATEGORY_SELECTOR_DATA, TpUiComponent: { cardRegistry: 'theme_prime_small_card_registry', defaultVal: { style: 'tp_category_product_card_style_1', includesChild: true, sortBy: 'list_price asc' } } }, defaultValue: { recordsLimit: 1 } })
    .add('s_d_single_product_snippet', { widgets: { ...SELECTOR_DATA }, defaultValue: { recordsLimit: 1 } })
    .add('s_d_single_product_cover_snippet', { widgets: { ...SELECTOR_DATA }, defaultValue: { recordsLimit: 1 } })
    ...
    .add('s_d_image_products_block', { widgets: { ...SELECTOR_DATA }})
    .add('s_d_top_categories', { widgets: { ...CATEGORY_SELECTOR_DATA, TpUiComponent: { cardRegistry: 'theme_prime_top_category_card_registry', defaultVal: { style: 'tp_category_category_card_style_1', sortBy: 'list_price asc', includesChild: true } } }, defaultValue: { recordsLimit: 3 } })
    ...
    .add('s_product_listing_cards', { widgets: { TpUiComponent: { cardRegistry: 'theme_prime_product_list_cards', defaultVal: { header: 'tp_product_list_header_1', style: 'tp_product_list_cards_1', limit: 5, bestseller: true, newArrived: true, discount: true } } }, defaultValue: { noSelection: true, maxValue: 5, minValue: 2 } })
    ...
    .add('s_product_listing_tabs', { widgets: { ...CATEGORY_SELECTOR_DATA, TpUiComponent: { cardRegistry: 'theme_prime_card_registry', defaultVal: { tabStyle: 'tp-droggol-dynamic-snippet-tab-1', style: 's_card_style_1', limit: 20, bestseller: true, newArrived: true, discount: true, mobileConfig: { style: 'default', mode: 'default' } } } }, defaultValue: { forceVisible: true, recordsLimit: 1 } })
    ...
    .add('s_mega_menu_category_tabs_snippet', { widgets: { ...CATEGORY_SELECTOR_DATA, TpUiComponent: { cardRegistry: 'theme_prime_mega_menu_tabs_styles', defaultVal: { style: 'tp_mega_menu_tab_style_1', childOrder: 'sequence', menuLabel: true, categoryTabsConfig: { activeRecordID: false, records: []}} } }, defaultValue: { noSwicher: true, lazy: true } });
