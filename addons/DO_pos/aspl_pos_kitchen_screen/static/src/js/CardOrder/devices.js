odoo.define('aspl_pos_kitchen_screen.devices', function (require) {
"use strict";

var core = require('web.core');
var mixins = require('web.mixins');
var Session = require('web.Session');
var Printer = require('aspl_pos_kitchen_screen.Printer').Printer;
...
var ProxyDevice  = core.Class.extend(mixins.PropertiesMixin,{
    ...
    connect: function(url){
        ...
        this.host = url;
        console.log("this.pos.config.iface_print_via_proxy----", this.pos.config.iface_print_via_proxy)
