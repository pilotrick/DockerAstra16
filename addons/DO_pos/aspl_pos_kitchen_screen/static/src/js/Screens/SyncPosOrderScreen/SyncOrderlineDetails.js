odoo.define('aspl_pos_kitchen_screen.SyncOrderlineDetails', function (require) {
    'use strict';
     ...
     */
    class SyncOrderlineDetails extends PosComponent {
        get line() {
    ...
    SyncOrderlineDetails.template = 'SyncOrderlineDetails';

    Registries.Component.add(SyncOrderlineDetails);

    return SyncOrderlineDetails;
});
