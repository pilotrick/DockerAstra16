odoo.define('aspl_pos_kitchen_combo.Orderline', function(require) {
    'use strict';
    ...
    const OrderLineInherit = Orderline =>
        class extends Orderline {
            ...
            customiseIconClicked(){
                this.trigger('customise-product', { orderline: this.props.line });
            }
            comboIconClicked(){
                this.trigger('edit-combo-product', { orderline: this.props.line });
            }
            async updateQuantity(){
                this.trigger('update-line-quantity', { orderline: this.props.line });
            }
