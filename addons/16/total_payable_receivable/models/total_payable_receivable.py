...
class ResPartner(models.Model):
    ...
    partner_credit = fields.Monetary(compute='credit_debit_get',string='Total por cobrar', help="El monto total que debe este cliente")
    partner_debit = fields.Monetary(compute='credit_debit_get',string='Total por pagar',help="El monto total que le debes a este suplidor.")
