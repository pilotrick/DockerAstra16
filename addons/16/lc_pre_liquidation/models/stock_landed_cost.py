...
class StockLandedCost(models.Model):
    ...
    metrics = fields.Text(
        ...
        compute="_compute_detail_metrics",
        readonly=True,
        help='Total FOB: Total del costo de acuerdo a los precios unitarios indicados en los Productos. \n'
            'Costo total actual: Costo total de los productos luego de aplicar el factor de costos en destino. \n'
            'PVP Promedio: Precio unitario de venta promedio de los productos \n'
            'PVP Media: Calculo de mediana de precios unitarios de venta de los productos \n'
            'Total ganancia: Suma de las ganancias'
    )
