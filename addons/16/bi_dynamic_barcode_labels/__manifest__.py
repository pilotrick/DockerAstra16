...
Barcode Labels for Products,Templates,Sale,Purchase,Picking
    ...
    'assets': {
        'web.assets_backend': [
            'bi_dynamic_barcode_labels/static/src/js/BrowserPrint.min.js',
            'bi_dynamic_barcode_labels/static/src/js/BrowserPrintZebra.js',
            'bi_dynamic_barcode_labels/static/src/js/sweetalert2.all.min.js',
            'bi_dynamic_barcode_labels/static/src/js/FileSaver.js',
            'bi_dynamic_barcode_labels/static/src/js/print_button.js',
