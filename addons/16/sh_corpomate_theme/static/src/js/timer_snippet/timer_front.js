...
//DOCUMENT READY START HERE
	...
	/*
	 * ###############################################
	 * TIMER js_cls_sh_corpomate_section_479
	 * sh_corpomate_theme_tmpl_479
	 * ###############################################
	 */
	function sh_timer_snippet_tmpl_479($el) {
    ...
    //IF TARGETED TIMER SNIPPET EXIST IN PAGE.
	var $snippet_timer = $(".js_cls_sh_corpomate_section_479");
	if($snippet_timer && $snippet_timer.length){
		$snippet_timer.each(function( index ) {
			sh_timer_snippet_tmpl_479( $( this ) );
