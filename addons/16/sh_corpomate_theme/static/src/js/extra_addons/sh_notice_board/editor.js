                ...
                if (marquee) {
                    ...
                    ajax.jsonRpc("/get_latest_news", "call", {
                        ...
                        _.each(data, function (news) {
                            new_marquee.append("<span>" + news.desc + "</span>");
                        });
                    });
            ...
            if (value && value.length) {
                ...
                if (marquee) {
                    ...
                    ajax.jsonRpc("/get_latest_news", "call", {
                        ...
                        _.each(data, function (news) {
                            new_marquee.append("<div class='sh_text'><span class='fa fa-caret-right' aria-hidden='true'> </span>" + news.desc + "</div>");
                        });
                    });
                    marquee.replaceWith(new_marquee);
                }
            ...
            if (value && value.length) {
                ...
                if (marquee) {
                    ...
                    ajax.jsonRpc("/get_latest_news", "call", {
                        ...
                        _.each(data, function (news) {
                            new_marquee.append("<div class='sh_news_description'><span class='fa fa-caret-right'> </span>" + news.desc + "</div>");
                        });
                    });
                    marquee.replaceWith(new_marquee);
                }
            ...
            if (value && value.length) {
                ...
                if (marquee) {
                    ...
                    ajax.jsonRpc("/get_latest_news", "call", {
                        ...
                        _.each(data, function (news) {
                            new_marquee.append("<div class='sh_news'><h4>" + news.name + "</h4><p>" + news.desc + "</p></div>");
                        });
                    });
                    marquee.replaceWith(new_marquee);
                }
            ...
            if (value && value.length) {
                ...
                if (marquee) {
                    ...
                    ajax.jsonRpc("/get_latest_news", "call", {
                        ...
                        _.each(data, function (news) {
                            new_marquee.append("<div class='sh_news_box'><h4>" + news.name + "</h4><p>" + news.desc + "</p></div>");
                        });
                    });
                    marquee.replaceWith(new_marquee);
                }
