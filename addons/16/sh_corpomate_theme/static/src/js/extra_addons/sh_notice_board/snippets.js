    ...
    Animation.registry.sh_nb_notice_board_horizontal_tmpl_2 = Animation.Class.extend({
        ...
        start: function () {
            ...
            ajax.jsonRpc("/get_latest_news", "call", {
                ...
                _.each(data, function (news) {
                    self.$el.append("<div class='sh_text'><span class='fa fa-caret-right' aria-hidden='true'> </span>" + news.desc + "</div>");
                });
            });
        },
    });
    ...
    Animation.registry.sh_nb_notice_board_horizontal_tmpl_3 = Animation.Class.extend({
        ...
        start: function () {
            ...
            ajax.jsonRpc("/get_latest_news", "call", {
                ...
                _.each(data, function (news) {
                    self.$el.append("<div class='sh_news_description'><span class='fa fa-caret-right'> </span>" + news.desc + "</div>");
                });
            });
        },
    });
