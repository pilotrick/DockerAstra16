odoo.define('sh_corpomate_theme.editor_js_snippet_builder', function (require) {
    'use strict';
    ...
    ajax.loadXML('/sh_corpomate_theme/static/src/xml/sh_snippet_builder/snippet_builder_popup.xml', core.qweb);
