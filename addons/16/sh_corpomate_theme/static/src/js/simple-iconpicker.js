...
jQuery(document).ready(function () {
    jQuery("body").prepend(
        '<div class="howl-iconpicker-outer" style="display:none;"><div class="howl-iconpicker-middle"><div class="howl-iconpicker"><div class="howl-closebtn"></div><input type="text" class="srchicons" placeholder="eg:google" /> <div class="iconsholder"></div></div><div class="howl-iconpicker-close">Close</div></div></div>'
    ); // Appending Iconpicker box below input box
