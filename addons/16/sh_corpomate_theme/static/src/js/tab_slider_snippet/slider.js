...
//document ready start here.
	 ...
	 */	
		...
		// BLOG SLIDER LAYOUT render function start here
		function sh_corpomate_theme_tmpl_418_layout($el) {
		    ...
		    //ajax call start here	
			ajax.jsonRpc('/sh_corpomate_theme/sh_tab_slider_snippet/sh_corpomate_theme_tmpl_418_tab_pane_layout', 'call', 
		       	 	{       
			    		'slider_id': 			slider_id,	    		
			    		
		   		    }).then(function (values) {

		   		    	$el.find('.js_cls_corpomate_blog_slider_main_div_418').replaceWith(values.data);
		...
		var $snippet_sections = $(".js_cls_corpomate_blog_slider_section_418");
		
		if($snippet_sections && $snippet_sections.length){
			
			$snippet_sections.each(function( index ) {
				
				sh_corpomate_theme_tmpl_418_layout( $( this )  );
		...
		// BLOG SLIDER LAYOUT render function start here
		function sh_corpomate_theme_tmpl_447_layout($el) {
		    ...
		    //ajax call start here	
			ajax.jsonRpc('/sh_corpomate_theme/sh_tab_slider_snippet/sh_corpomate_theme_tmpl_447_tab_pane_layout', 'call', 
		       	 	{       
			    		'slider_id': 			slider_id,	    		
			    		
		   		    }).then(function (values) {

		   		    	$el.find('.js_cls_corpomate_blog_slider_main_div_447').replaceWith(values.data);
		...
		var $snippet_sections = $(".js_cls_corpomate_blog_slider_section_447");
		
		if($snippet_sections && $snippet_sections.length){
			
			$snippet_sections.each(function( index ) {
				
				sh_corpomate_theme_tmpl_447_layout( $( this )  );
		...
		//ON CLICK SLIDER TAB PANE.
		$('.js_cls_corpomate_blog_slider_section_447').on('click','.js_cls_corpomate_blog_slider_nav_tabs_ul_447 a',function (e) {
		    e.preventDefault();
		    ...
		    //ajax call start here	
			ajax.jsonRpc('/sh_corpomate_theme/sh_tab_slider_snippet/sh_corpomate_theme_tmpl_447_tab_pane_one', 'call', 
		       	 	{       
			    		'tab_id':	tab_id,	
			    		'token':	token,		    				    		
		   		    	...
		   		    	$el.find('.js_cls_corpomate_blog_slider_tab_content_447 ' + tab_href_find ).replaceWith(values.data);
		...
		// BLOG SLIDER LAYOUT render function start here
		function sh_corpomate_theme_tmpl_482_layout($el) {
		    ...
		    //ajax call start here	
			ajax.jsonRpc('/sh_corpomate_theme/sh_tab_slider_snippet/sh_corpomate_theme_tmpl_482_tab_pane_layout', 'call', 
		       	 	{       
			    		'slider_id': 			slider_id,	    		
			    		
		   		    }).then(function (values) {

		   		    	$el.find('.js_cls_corpomate_blog_slider_main_div_482').replaceWith(values.data);
		   		    	var is_rtl_enabled =  $('#wrapwrap').hasClass('o_rtl');
		   		    	//refresh the owl start here
		   		    	$el.find('.owl-carousel').owlCarousel({
	                        items:		values.items,
		...
		var $snippet_sections = $(".js_cls_corpomate_blog_slider_section_482");
		
		if($snippet_sections && $snippet_sections.length){
			
			$snippet_sections.each(function( index ) {
				
				sh_corpomate_theme_tmpl_482_layout( $( this )  );
		...
		//ON CLICK SLIDER TAB PANE.
		$('.js_cls_corpomate_blog_slider_section_482').on('click','.js_cls_corpomate_blog_slider_nav_tabs_ul_482 a',function (e) {
		    e.preventDefault();
		    ...
		    //ajax call start here	
			ajax.jsonRpc('/sh_corpomate_theme/sh_tab_slider_snippet/sh_corpomate_theme_tmpl_482_tab_pane_one', 'call', 
		       	 	{       
			    		'tab_id':	tab_id,	
			    		'token':	token,		    				    		
		   		    	...
		   		    	$el.find('.js_cls_corpomate_blog_slider_tab_content_482 ' + tab_href_find ).replaceWith(values.data);
		   		        var is_rtl_enabled =  $('#wrapwrap').hasClass('o_rtl');
		   		    	//refresh the owl start here
		   		    	$el.find('.owl-carousel').owlCarousel({
	                        items:		values.items,
		...
		// BLOG SLIDER LAYOUT render function start here
		function sh_corpomate_theme_tmpl_508_layout($el) {
		    ...
		    //ajax call start here	
			ajax.jsonRpc('/sh_corpomate_theme/sh_tab_slider_snippet/sh_corpomate_theme_tmpl_508_tab_pane_layout', 'call', 
		       	 	{       
			    		'slider_id': 			slider_id,	    		
			    		
		   		    }).then(function (values) {

		   		    	$el.find('.js_cls_corpomate_blog_slider_main_div_508').replaceWith(values.data);
		   		    	var is_rtl_enabled =  $('#wrapwrap').hasClass('o_rtl');
		   		    	//refresh the owl start here
		   		    	$el.find('.owl-carousel').owlCarousel({
	                        items:		values.items,
		...
		//ON CLICK SLIDER TAB PANE.
		$('.js_cls_corpomate_blog_slider_section_541').on('click','.js_cls_corpomate_blog_slider_nav_tabs_ul_541 a',function (e) {
		    e.preventDefault();
		    ...
		    //ajax call start here	
			ajax.jsonRpc('/sh_corpomate_theme/sh_tab_slider_snippet/sh_corpomate_theme_tmpl_541_tab_pane_one', 'call', 
		       	 	{       
			    		'tab_id':	tab_id,	
			    		'token':	token,		    				    		
		   		    	...
		   		    	$el.find('.js_cls_corpomate_blog_slider_tab_content_541 ' + tab_href_find ).replaceWith(values.data);
		 ...
		 * ###################################################################################
		 * ***************************************
		 * blog 20 template 508 theme 20
		 * ************************
		 * ################################################################################### */
		
		var $snippet_sections = $(".js_cls_corpomate_blog_slider_section_508");
		
		if($snippet_sections && $snippet_sections.length){
			
			$snippet_sections.each(function( index ) {
				
				sh_corpomate_theme_tmpl_508_layout( $( this )  );
		...
		//ON CLICK SLIDER TAB PANE.
		$('.js_cls_corpomate_blog_slider_section_508').on('click','.js_cls_corpomate_blog_slider_nav_tabs_ul_508 a',function (e) {
		    e.preventDefault();
		    ...
		    //ajax call start here	
			ajax.jsonRpc('/sh_corpomate_theme/sh_tab_slider_snippet/sh_corpomate_theme_tmpl_508_tab_pane_one', 'call', 
		       	 	{       
			    		'tab_id':	tab_id,	
			    		'token':	token,		    				    		
		   		    	...
		   		    	$el.find('.js_cls_corpomate_blog_slider_tab_content_508 ' + tab_href_find ).replaceWith(values.data);
		   		        var is_rtl_enabled =  $('#wrapwrap').hasClass('o_rtl');
		   		    	//refresh the owl start here
		   		    	$el.find('.owl-carousel').owlCarousel({
	                        items:		values.items,
...
/* 
		...
		// BLOG SLIDER LAYOUT render function start here
		function sh_corpomate_theme_tmpl_541_layout($el) {
		    ...
		    //ajax call start here	
			ajax.jsonRpc('/sh_corpomate_theme/sh_tab_slider_snippet/sh_corpomate_theme_tmpl_541_tab_pane_layout', 'call', 
		       	 	{       
			    		'slider_id': 			slider_id,	    		
			    		
		   		    }).then(function (values) {

		   		    	$el.find('.js_cls_corpomate_blog_slider_main_div_541').replaceWith(values.data);
		   		    	var is_rtl_enabled =  $('#wrapwrap').hasClass('o_rtl');
		   		    	//refresh the owl start here
		   		    	$el.find('.owl-carousel').owlCarousel({
	                        items:		values.items,
		...
		var $snippet_sections = $(".js_cls_corpomate_blog_slider_section_541");
		
		if($snippet_sections && $snippet_sections.length){
			
			$snippet_sections.each(function( index ) {
				
				sh_corpomate_theme_tmpl_541_layout( $( this )  );
