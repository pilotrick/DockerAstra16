...
# Part of Odoo. See LICENSE file for full copyright and licensing details.
{
    ...
    'summary': """
        ...
        Advance reorder, order points, reordering rule, advance purchase ordering, 
        sales forecast, inter company transfer, inter warehouse transfer, stock replenishment, demand, 
    ...
    'depends': ['stock', 'purchase', 'setu_intercompany_transaction'],
    'license': 'OPL-1',
    'sequence': 26,
    'data': [
