...
class ProcurementGroup(models.Model):
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        for procurement in procurements:
            ...
            ########################################################################
            if self._context.get('custom_order_point_function', False):
    ...
    def run_scheduler(self, use_new_cursor=False, company_id=False):
        ...
        return super(ProcurementGroup, self.with_context(context)).run_scheduler(use_new_cursor=use_new_cursor, company_id=company_id)
