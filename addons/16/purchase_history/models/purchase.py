...
class PurchaseOrderLine(models.Model):
    ...
    last_price1 = fields.Float('UPDC 1', help="Muestra el último precio de compra del producto para el proveedor seleccionado de las últimas dos órdenes de compra")
    last_price2 = fields.Float('UPDC 2', help="Muestra el penúltimo precio de compra del producto para el proveedor seleccionado de las últimas dos órdenes de compra")
