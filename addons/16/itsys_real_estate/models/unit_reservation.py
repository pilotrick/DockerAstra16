...
class unit_reservation(models.Model):
    ...
    text1 = fields.Char(string="باكية بدروم", required=False, )
    text2 = fields.Char(string="وديعة صيانة", required=False, )
    payment_type = fields.Selection(string="طريقة الدفع", selection=[('cash', 'كاش'), ('debit', 'قسط'), ], required=False, )
    ...
    def action_contract_ownership(self):
        return {
            ...
            'context': {
                ...
                'default_advance_payment': self.advance_payment,
            },
            'target': 'current'
        }
